...
(1, 'Sagan om Ringen', 'J.R.R. Tolkien', 'Bok', 1),
(2, 'National Geographic', 'National Geographic Society', 'Tidskrifter', 0),
(3, 'Star Wars: A New Hope', 'George Lucas', 'Media', 0),
(4, 'Harry Potter och De Vises Sten', 'J.K. Rowling', 'Bok', 1),
(5, 'Time Magazine', 'Time Inc.', 'Tidskrifter', 1);
...
(3, 1, 4, '2025-01-24', '2025-02-23'),
(4, 1, 5, '2025-01-24', '2025-02-03'),
(5, 1, 1, '2025-01-24', '2025-02-23');
...
(1, 'admin', 'admin123', 'Admin Användare', 'admin@example.com', '2025-01-22 18:22:17'),
(2, 'user1', 'password1', 'Första Användare', 'user1@example.com', '2025-01-22 18:22:17'),
(3, 'user2', 'password2', 'Andra Användare', 'user2@example.com', '2025-01-22 18:22:17');
